'''
O jogo Gorilas é um jogo clássico de turnos, no qual cada jogador espera sua vez de jogar.

Os links em anexo mostram exemplos de implementações e permitem entender o que é esperado na entrega.

O jogo deve ter:
1 - Menu de entrada;
2 - Ranking dos melhores jogadores;
3 - Configurações de nível de dificuldade.

Funcionalidades para bolinha:
