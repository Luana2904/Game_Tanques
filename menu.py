    ...
    while 1:
        ...
        if key == curses.KEY_UP and current_row_idx > 0:
            ...
            if menu[current_row_idx] == "Jogar":
                ...
                stdscr.addstr(y+2, x, 'Digite o nível de dificuldade: facil, medio ou dificil?')
                dificuldade_win = curses.newwin(1, 20, y+2, x+56)
                stdscr.refresh()
                ...
                rodadas_win = curses.newwin(1, 20, y+3, x+32)
                stdscr.refresh()
                ...
                gravidade_win = curses.newwin(1, 20, y+4, x+20)
                stdscr.refresh()
